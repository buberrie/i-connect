  ...
  return (
    <div className="auth2-container">
      <form className="auth-form" onSubmit={handleSubmit}>
        <div className="signupform2-container">
          <div className="signupform2-header">
            <div className="logo">
              <img src={logoImg} alt="" />
            </div>
          </div>
          ...
          <div className="form-group">
            <label htmlFor="fullName" className="signup2-label">
              Full Name
              <input
            ...
            <label htmlFor="email" className="signup2-label">
              Email
              <input
                className="signup2-input"
                type="email"
            ...
            <label htmlFor="password" className="signup2-label">
              Password
              <input
                className="signup2-input"
                type="password"
            ...
            <label htmlFor="confirmPassword" className="signup2-label">
              Confirm Password
              <input
                className="signup2-input"
                type="password"
            ...
            <label htmlFor="username" className="signup2-label">
              Username
              <input
                className="signup2-input"
                type="text"
            ...
            <label htmlFor="phoneNumber" className="signup2-label">
              Phone Number
              <input
                className="signup2-input"
                type="tel"
          ...
          <div className="signup2-btn-div">
            <Button text="Create an Account" className="signup-btn" />
          </div>

          <div className="alt">
            <div className="signup2-line"></div>
            <span>OR</span>
            <div className="signup2-line"></div>
          </div>
